...
export const config = {
  ...
  // Gemini models — gemini-1.5-flash has a much more generous free tier
  // than gemini-2.0-flash (which is gated to limit=0 on free projects).
...
// NOTE: standard-specific specialist agents (ERC-20/721/1155/4626/1967/1271,
// TEP-74/62, SPL/Metaplex, BRC-20/Runes/Ordinals, TRC-20/721, IBC/ICS,
// XCM/PSP) now live in lib/standards.ts and are merged in by the pipeline.
