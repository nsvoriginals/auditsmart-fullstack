...
import {
  ...
  type HighlightProps,
} from '@/components/workspace/components/animate-ui/primitives/effects/highlight';
import {
  Accordion,
  AccordionItem,
  AccordionHeader,
...
} from '@/components/workspace/components/animate-ui/primitives/radix/accordion';
import { getStrictContext } from '@/components/workspace/lib/get-strict-context';
import { useControlledState } from '@/components/workspace/hooks/use-controlled-state';
